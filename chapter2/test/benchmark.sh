...
# cache 写
echo "[cache-set] [cache-benchmark -type tcp -h 127.0.0.1:9091 -n 10000 -r 10000 -t set]"
cache-benchmark -type tcp -h 127.0.0.1:9091 -n 10000 -r 10000 -t set

echo ""
# cache 读
echo "[cache-get] [cache-benchmark -type tcp -h 127.0.0.1:9091 -n 10000 -r 10000 -t get]"
cache-benchmark -type tcp -h 127.0.0.1:9091 -n 10000 -r 10000 -t get
